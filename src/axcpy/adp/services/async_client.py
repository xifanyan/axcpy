...
class AsyncADPClient:
    """Async HTTP client for interacting with ADP endpoints using PUT-only semantics.
    ...
    async def __aenter__(self) -> AsyncADPClient:  # pragma: no cover
        return self
