...
[
  ...
  {
    "taskType": "Cancel Publish",
    "taskConfiguration": {
      "adp_cp_webserviceUrl": "http://{host_name}/{project_name}",
      "adp_progressTaskTimeout": 0,
      "adp_cp_matterId": "default",
      "adp_cp_httpsTrustCertificate": "",
      "adp_taskActive": true,
      "adp_cp_webservicePassword": "",
      "adp_cp_webserviceUser": "{service_user}",
      "adp_cp_httpsPassword": "",
      "adp_cp_usedWebserviceUrl": "adp_url_used_for_cancelling_publish",
      "adp_executionPersistent": true,
      "adp_cp_matterSpecificApplication": null,
      "adp_cp_matterSpecificUrlRegEx": null,
      "adp_abortWfOnFailure": true,
      "adp_cleanUpHistory": false,
      "adp_cp_httpsKeystoreFile": null,
      "adp_loggingEnabled": true,
      "adp_cp_webserviceConnectTimeoutSeconds": 300,
      "adp_taskTimeout": 0,
      "adp_cp_httpsAllowUntrustedHosts": "false",
      "adp_cp_cancelledPublishes": "adp_cancelled_publishes",
      "adp_cp_webserviceRequestTimeoutSeconds": 900
    },
    "taskDescription": "This task cancels publishing a matter into Review, Investigation or ECA applications. It cancels all publishing processes currently running for the specified matter. Some documents in the source engine might be tagged with categories from the cancelled publish processes.",
    "taskDisplayName": "Task to cancel a matter publish"
  },
  {
  ...
  },
  {
    ...
    "taskConfiguration": {
      ...
      "adp_createApplication_rebaseOnLatestSystemTemplate": "false",
  ...
  },
  {
    ...
    "taskConfiguration": {
      ...
      "adp_cinv_rebaseOnLatestSystemTemplate": "false",
  ...
  },
  {
    ...
    "taskConfiguration": {
      ...
      "adp_taskTimeout": 0,
      "adp_cri_rebaseOnLatestSystemTemplate": "false",
